...
class FingerNetSave(nn.Module):
    ...
    def forward(self, input, label_nc=1):
        ...
        self.activations['bn_input'] = bn_input
        out = self.conv1_1(bn_input)
        self.activations['conv1_1'] = out
        out = self.bn1_1(out)
        self.activations['bn1_1'] = out
        out = self.prelu1_1(out)
        self.activations['prelu1_1'] = out
        out = self.conv1_2(out)
        self.activations['conv1_2'] = out
        out = self.bn1_2(out)
        self.activations['bn1_2'] = out
        out = self.prelu1_2(out)
        self.activations['prelu1_2'] = out
        out = self.max_pooling2d_1(out)
        self.activations['max_pooling2d_1'] = out
        out = self.conv2_1(out)
        self.activations['conv2_1'] = out
        out = self.bn2_1(out)
        self.activations['bn2_1'] = out
        out = self.prelu2_1(out)
        self.activations['prelu2_1'] = out
        out = self.conv2_2(out)
        self.activations['conv2_2'] = out
        out = self.bn2_2(out)
        self.activations['bn2_2'] = out
        out = self.prelu2_2(out)
        self.activations['prelu2_2'] = out
        out = self.max_pooling2d_2(out)
        self.activations['max_pooling2d_2'] = out
        out = self.conv3_1(out)
        self.activations['conv3_1'] = out
        out = self.bn3_1(out)
        self.activations['bn3_1'] = out
        out = self.prelu3_1(out)
        self.activations['prelu3_1'] = out
        out = self.conv3_2(out)
        self.activations['conv3_2'] = out
        out = self.bn3_2(out)
        self.activations['bn3_2'] = out
        out = self.prelu3_2(out)
        self.activations['prelu3_2'] = out
        out = self.conv3_3(out)
        self.activations['conv3_3'] = out
        out = self.bn3_3(out)
        self.activations['bn3_3'] = out
        out = self.prelu3_3(out)
        self.activations['prelu3_3'] = out
        out = self.max_pooling2d_3(out)
        self.activations['max_pooling2d_3'] = out
        # scale 1
        scale1 = self.conv4_1(out)
        self.activations['conv4_1'] = scale1
        scale1 = self.bn4_1(scale1)
        self.activations['bn4_1'] = scale1
        scale1 = self.prelu4_1(scale1)
        self.activations['prelu4_1'] = scale1
        ori_1 = self.convori_1_1(scale1)
        self.activations['convori_1_1'] = ori_1
        ori_1 = self.bnori_1_1(ori_1)
        self.activations['bnori_1_1'] = ori_1
        ori_1 = self.preluori_1_1(ori_1)
        self.activations['preluori_1_1'] = ori_1
        ori_1 = self.ori_1_2(ori_1)
        self.activations['ori_1_2'] = ori_1
        seg_1 = self.convseg_1_1(scale1)
        self.activations['convseg_1_1'] = seg_1
        seg_1 = self.bnseg_1_1(seg_1)
        self.activations['bnseg_1_1'] = seg_1
        seg_1 = self.preluseg_1_1(seg_1)
        self.activations['preluseg_1_1'] = seg_1
        seg_1 = self.seg_1_2(seg_1)
        self.activations['seg_1_2'] = seg_1
        # scale 2
        scale2 = self.atrousconv4_2(out)
        self.activations['atrousconv4_2'] = scale2
        scale2 = self.bn4_2(scale2)
        self.activations['bn4_2'] = scale2
        scale2 = self.prelu4_2(scale2)
        self.activations['prelu4_2'] = scale2
        ori_2 = self.convori_2_1(scale2)
        self.activations['convori_2_1'] = ori_2
        ori_2 = self.bnori_2_1(ori_2)
        self.activations['bnori_2_1'] = ori_2
        ori_2 = self.preluori_2_1(ori_2)
        self.activations['preluori_2_1'] = ori_2
        ori_2 = self.ori_2_2(ori_2)
        self.activations['ori_2_2'] = ori_2
        seg_2 = self.convseg_2_1(scale2)
        self.activations['convseg_2_1'] = seg_2
        seg_2 = self.bnseg_2_1(seg_2)
        self.activations['bnseg_2_1'] = seg_2
        seg_2 = self.preluseg_2_1(seg_2)
        self.activations['preluseg_2_1'] = seg_2
        seg_2 = self.seg_2_2(seg_2)
        self.activations['seg_2_2'] = seg_2
        # scale 3
        scale3 = self.atrousconv4_3(out)
        self.activations['atrousconv4_3'] = scale3
        scale3 = self.bn4_3(scale3)
        self.activations['bn4_3'] = scale3
        scale3 = self.prelu4_3(scale3)
        self.activations['prelu4_3'] = scale3
        ori_3 = self.convori_3_1(scale3)
        self.activations['convori_3_1'] = ori_3
        ori_3 = self.bnori_3_1(ori_3)
        self.activations['bnori_3_1'] = ori_3
        ori_3 = self.preluori_3_1(ori_3)
        self.activations['preluori_3_1'] = ori_3
        ori_3 = self.ori_3_2(ori_3)
        self.activations['ori_3_2'] = ori_3
        seg_3 = self.convseg_3_1(scale3)
        self.activations['convseg_3_1'] = seg_3
        seg_3 = self.bnseg_3_1(seg_3)
        self.activations['bnseg_3_1'] = seg_3
        seg_3 = self.preluseg_3_1(seg_3)
        self.activations['preluseg_3_1'] = seg_3
        seg_3 = self.seg_3_2(seg_3)
        self.activations['seg_3_2'] = seg_3

        ori_out = ori_1 + ori_2 + ori_3
        self.activations['ori_out'] = ori_out
        ori_out_1 = nn.Sigmoid()(ori_out)
        self.activations['ori_out_1'] = ori_out_1
        ori_out_2 = nn.Sigmoid()(ori_out)
        self.activations['ori_out_2'] = ori_out_2
        seg_out = seg_1 + seg_2 + seg_3
        self.activations['seg_out'] = seg_out
        seg_out = nn.Sigmoid()(seg_out)
        self.activations['seg_out'] = seg_out

        filter_img_real = self.enh_img_real_1(input)
        self.activations['filter_img_real'] = filter_img_real
        filter_img_imag = self.enh_img_imag_1(input)
        self.activations['filter_img_imag'] = filter_img_imag

        ori_peak = self.ori_peak(ori_out_1)
        self.activations['ori_peak'] = ori_peak
        ...
        self.activations['upsample_ori'] = upsample_ori
        seg_round = nn.Softsign()(seg_out)
        self.activations['seg_round'] = seg_round
        upsample_seg = nn.UpsamplingNearest2d(size=(seg_round.shape[2] * 8, seg_round.shape[3] * 8))(seg_round)
        self.activations['upsample_seg'] = upsample_seg
        mul_mask_real = filter_img_real * upsample_ori
        self.activations['mul_mask_real'] = mul_mask_real
        enh_img_real = reduce_sum_torch(mul_mask_real)
        self.activations['enh_img_real'] = enh_img_real
        mul_mask_imag = filter_img_imag * upsample_ori
        self.activations['mul_mask_imag'] = mul_mask_imag
        enh_img_imag = reduce_sum_torch(mul_mask_imag)
        self.activations['enh_img_imag'] = enh_img_imag
        enh_img = atan2_torch([enh_img_imag, enh_img_real])
        self.activations['enh_img'] = enh_img
        enh_seg_img = merge_concat_torch([enh_img, upsample_seg])
        self.activations['enh_seg_img'] = enh_seg_img
        # ----------------------------------------------------------------------------
        # mnt part
        mnt_conv = self.convmnt_1_1(enh_seg_img)
        self.activations['convmnt_1_1'] = mnt_conv
        mnt_conv = self.bnmnt_1_1(mnt_conv)
        self.activations['bnmnt_1_1'] = mnt_conv
        mnt_conv = self.prelumnt_1_1(mnt_conv)
        self.activations['prelumnt_1_1'] = mnt_conv
        mnt_conv = self.max_pooling2d_4(mnt_conv)
        self.activations['max_pooling2d_4'] = mnt_conv
        
        mnt_conv = self.convmnt_2_1(mnt_conv)
        self.activations['convmnt_2_1'] = mnt_conv
        mnt_conv = self.bnmnt_2_1(mnt_conv)
        self.activations['bnmnt_2_1'] = mnt_conv
        mnt_conv = self.prelumnt_2_1(mnt_conv)
        self.activations['prelumnt_2_1'] = mnt_conv
        mnt_conv = self.max_pooling2d_4(mnt_conv)
        self.activations['max_pooling2d_4'] = mnt_conv
        mnt_conv = self.convmnt_3_1(mnt_conv)
        self.activations['convmnt_3_1'] = mnt_conv
        mnt_conv = self.bnmnt_3_1(mnt_conv)
        self.activations['bnmnt_3_1'] = mnt_conv
        mnt_conv = self.prelumnt_3_1(mnt_conv)
        self.activations['prelumnt_3_1'] = mnt_conv
        mnt_conv = self.max_pooling2d_4(mnt_conv)
        self.activations['max_pooling2d_4'] = mnt_conv

        mnt_o_1 = merge_concat_torch([mnt_conv, ori_out_1])
        self.activations['mnt_o_1'] = mnt_o_1
        mnt_o_2 = self.convmnt_o_1_1(mnt_o_1)
        self.activations['convmnt_o_1_1'] = mnt_o_2
        mnt_o_2 = self.bnmnt_o_1_1(mnt_o_2)
        self.activations['bnmnt_o_1_1'] = mnt_o_2
        mnt_o_2 = self.prelumnt_o_1_1(mnt_o_2)
        self.activations['prelumnt_o_1_1'] = mnt_o_2
        mnt_o_3 = self.mnt_o_1_2(mnt_o_2)
        self.activations['mnt_o_1_2'] = mnt_o_3
        mnt_o_out = nn.Sigmoid()(mnt_o_3)
        self.activations['mnt_o_out'] = mnt_o_out

        mnt_w_1 = self.convmnt_w_1_1(mnt_conv)
        self.activations['convmnt_w_1_1'] = mnt_w_1
        mnt_w_1 = self.bnmnt_w_1_1(mnt_w_1)
        self.activations['bnmnt_w_1_1'] = mnt_w_1
        mnt_w_1 = self.prelumnt_w_1_1(mnt_w_1)
        self.activations['prelumnt_w_1_1'] = mnt_w_1
        mnt_w_2 = self.mnt_w_1_2(mnt_w_1)
        self.activations['mnt_w_1_2'] = mnt_w_2
        mnt_w_out = nn.Sigmoid()(mnt_w_2)
        self.activations['mnt_w_out'] = mnt_w_out

        mnt_h_1 = self.convmnt_h_1_1(mnt_conv)
        self.activations['convmnt_h_1_1'] = mnt_h_1
        mnt_h_1 = self.bnmnt_h_1_1(mnt_h_1)
        self.activations['bnmnt_h_1_1'] = mnt_h_1
        mnt_h_1 = self.prelumnt_h_1_1(mnt_h_1)
        self.activations['prelumnt_h_1_1'] = mnt_h_1
        mnt_h_2 = self.mnt_h_1_2(mnt_h_1)
        self.activations['mnt_h_1_2'] = mnt_h_2
        mnt_h_out = nn.Sigmoid()(mnt_h_2)
        self.activations['mnt_h_out'] = mnt_h_out

        mnt_s_1 = self.convmnt_s_1_1(mnt_conv)
        self.activations['convmnt_s_1_1'] = mnt_s_1
        mnt_s_1 = self.bnmnt_s_1_1(mnt_s_1)
        self.activations['bnmnt_s_1_1'] = mnt_s_1
        mnt_s_1 = self.prelumnt_s_1_1(mnt_s_1)
        self.activations['prelumnt_s_1_1'] = mnt_s_1
        mnt_s_2 = self.mnt_s_1_2(mnt_s_1)
        self.activations['mnt_s_1_2'] = mnt_s_2
        mnt_s_out = nn.Sigmoid()(mnt_s_2)
        self.activations['mnt_s_out'] = mnt_s_out
        
        torch.save(self.activations, 'activations.pth')
